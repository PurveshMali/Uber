...
const Home = () => {
  return (
    <div>
      <div className="bg-cover bg-center bg-[url(https://img.freepik.com/free-vector/person-with-medical-mask-concept-illustration_114360-2152.jpg?t=st=1738087371~exp=1738090971~hmac=d40fcd715455aa54400b52fce783ccc71e4734be9f489599a62541363fd332b3&w=740)] h-screen pt-8 w-full flex justify-between flex-col bg-red-400">
